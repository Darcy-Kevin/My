    ...
    <div className="relative w-full overflow-x-hidden">
      ...
      <section className="py-12 px-4 animate-in delay-1">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-4">
          <div className="md:col-span-4 relative h-[300px] md:h-[500px] overflow-hidden rounded-3xl group shadow-sm border border-border">
            <Image src="/25.12.28-zgcpark/DSC04574.jpg" alt="土豆" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
          ...
          <div className="md:col-span-5 flex flex-col gap-4">
            <div className="relative h-[242px] overflow-hidden rounded-3xl group border border-border">
              <Image src="/25.12.28-zgcpark/DSC04582.jpg" alt="土豆" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
            </div>
            <div className="relative h-[242px] overflow-hidden rounded-3xl group border border-border">
              <Image src="/25.12.28-zgcpark/DSC04583.jpg" alt="土豆" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
            </div>
          </div>

          <div className="md:col-span-3 relative h-[300px] md:h-[500px] overflow-hidden rounded-3xl group border border-border">
            <Image src="/25.12.28-zgcpark/DSC04580_(2).jpg" alt="土豆" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
          </div>
        </div>
      </section>
